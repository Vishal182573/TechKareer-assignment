...
const Header: React.FC<HeaderProps> = ({ toggleSidebar }) => {
  return (
    <div className='flex justify-between items-center p-5 lg:p-4 shadow-sm w-full text-gray-400 font-semibold'>
      <div className='flex justify-center lg:justify-start items-center space-x-10'>
